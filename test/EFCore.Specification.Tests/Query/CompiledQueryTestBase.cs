...
namespace Microsoft.EntityFrameworkCore.Query
{
        ...
        where TFixture : NorthwindQueryFixtureBase<NoopModelCustomizer>, new()
    {
        ...
        public virtual async Task DbSet_query(bool isAsync)
        {
            var query = EF.CompileEnumerableQuery((NorthwindContext context) => context.Customers);

            using (var context = CreateContext())
            {
                var result = isAsync
                    ? await query.ExecuteAsync(context).ToListAsync()
                    : query.Execute(context).ToList();
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public virtual async Task DbSet_query_first(bool isAsync)
        {
            var query = EF.CompileSingletonQuery(
                (NorthwindContext context) => context.Customers.OrderBy(c => c.CustomerID).First());

            using (var context = CreateContext())
            {
                var result = isAsync
                    ? await query.ExecuteAsync(context)
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public virtual async Task DbQuery_query(bool isAsync)
        {
#pragma warning disable CS0618 // Type or member is obsolete
            var query = EF.CompileEnumerableQuery((NorthwindContext context) => context.CustomerQueries.AsNoTracking());
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public virtual async Task DbQuery_query_first(bool isAsync)
        {
            var query = EF.CompileSingletonQuery(
                (NorthwindContext context) => context.CustomerQueries.AsNoTracking().OrderBy(c => c.CompanyName).First());
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public virtual async Task Query_ending_with_include(bool isAsync)
        {
            var query = EF.CompileEnumerableQuery(
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public virtual async Task Untyped_context(bool isAsync)
        {
            var query = EF.CompileEnumerableQuery((DbContext context) => context.Set<Customer>());
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public virtual async Task Query_with_single_parameter(bool isAsync)
        {
            var query = EF.CompileEnumerableQuery(
            ...
            {
                var result = isAsync
                    ? await query.ExecuteAsync(context, cancellationToken: default, "ALFKI").ToListAsync()
                    : query.Execute(context, "ALFKI").ToList();
            ...
            {
                var result = isAsync
                    ? await query.ExecuteAsync(context, cancellationToken: default, "ANATR").ToListAsync()
                    : query.Execute(context, "ANATR").ToList();

                Assert.Equal("ANATR", result.First().CustomerID);
            }
        }

        //        [ConditionalTheory]
        //        public virtual async Task Query_with_single_parameter_with_include(bool isAsync)
        //        {
        ...
        //        [ConditionalTheory]
        //        public virtual async Task First_query_with_single_parameter(bool isAsync)
        //        {
        //            var query = EF.CompileQuery(
        //                (NorthwindContext context, string customerID)
        ...
        //        [ConditionalTheory]
        //        public virtual async Task Query_with_two_parameters(bool isAsync)
        //        {
        //            var query = EF.CompileQuery(
        ...
        //        [ConditionalTheory]
        //        public virtual async Task Query_with_three_parameters(bool isAsync)
        //        {
        //            var query = EF.CompileQuery(
        ...
        //        public virtual async Task Query_with_array_parameter(bool isAsync)
        //        {
        //            var query = EF.CompileQuery(
        ...
        //        [ConditionalTheory]
        //        public virtual async Task Query_with_contains(bool isAsync)
        //        {
        //            var query = EF.CompileQuery(
        //                (NorthwindContext context, string[] args)
        ...
        //        public virtual async Task Multiple_queries(bool isAsync)
        //        {
        //            var query = EF.CompileQuery(
        //                (NorthwindContext context)
        ...
        //        [ConditionalTheory]
        //        public virtual async Task Query_with_closure(bool isAsync)
        //        {
        ...
        //        [ConditionalTheory]
        //        public virtual async Task Query_with_closure_null(bool isAsync)
        //        {
        ...
        //        [ConditionalTheory]
        //        public virtual async Task DbSet_query_async(bool isAsync)
        //        {
        ...
        //        [ConditionalTheory]
        //        public virtual async Task DbSet_query_first_async(bool isAsync)
        //        {
        ...
        //        [ConditionalTheory]
        //        public virtual async Task DbQuery_query_async(bool isAsync)
        //        {
        //#pragma warning disable CS0618 // Type or member is obsolete
        ...
        //        [ConditionalTheory]
        //        public virtual async Task DbQuery_query_first_async(bool isAsync)
        //        {
        //            var query = EF.CompileAsyncQuery(
        //                (NorthwindContext context)
        ...
        //        [ConditionalTheory]
        //        public virtual async Task Untyped_context_async(bool isAsync)
        //        {
        ...
        //        [ConditionalTheory]
        //        public virtual async Task Query_with_single_parameter_async(bool isAsync)
        //        {
        //            var query = EF.CompileAsyncQuery(
        //                (NorthwindContext context, string customerID)
        //                    => context.Customers.Where(c => c.CustomerID == customerID));
        ...
        //        [ConditionalTheory]
        //        public virtual async Task First_query_with_single_parameter_async(bool isAsync)
        //        {
        //            var query = EF.CompileAsyncQuery(
        //                (NorthwindContext context, string customerID)
        //                    => context.Customers.First(c => c.CustomerID == customerID));
        ...
        //        [ConditionalTheory]
        //        public virtual async Task First_query_with_cancellation_async(bool isAsync)
        //        {
        //            var query = EF.CompileAsyncQuery(
        ...
        //        [ConditionalTheory]
        //        public virtual async Task Query_with_two_parameters_async(bool isAsync)
        //        {
        //            var query = EF.CompileAsyncQuery(
        //                (NorthwindContext context, object _, string customerID)
        //                    => context.Customers.Where(c => c.CustomerID == customerID));
        ...
        //        [ConditionalTheory]
        //        public virtual async Task Query_with_three_parameters_async(bool isAsync)
        //        {
        //            var query = EF.CompileAsyncQuery(
        //                (NorthwindContext context, object _, int __, string customerID)
        //                    => context.Customers.Where(c => c.CustomerID == customerID));
        ...
        //        [ConditionalFact(Skip = "Issue #14935. Cannot eval 'where ([c].CustomerID == __args[0])'")]
        //        public virtual async Task Query_with_array_parameter_async(bool isAsync)
        //        {
        //            var query = EF.CompileAsyncQuery(
        //                (NorthwindContext context, string[] args)
        //                    => context.Customers.Where(c => c.CustomerID == args[0]));
        ...
        //        [ConditionalTheory]
        //        public virtual async Task Query_with_closure_async(bool isAsync)
        //        {
        //            var customerID = "ALFKI";
        ...
        //        [ConditionalTheory]
        //        public virtual async Task Query_with_closure_async_null(bool isAsync)
        //        {
        //            string customerID = null;
